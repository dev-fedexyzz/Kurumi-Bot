...
KurumiJadiBot({pathKurumiJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}}}}
...
}, 3 * 60 * 1000); // 3 minutos de eliminación 
// Tmp
setInterval(async () => {
